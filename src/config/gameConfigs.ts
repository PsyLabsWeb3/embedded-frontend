...
// Add Cyber Arena
gameConfigs["13-cyber-arena"] = {
  id: "13-cyber-arena",
  title: "Cyber Arena",
  description:
    "Fast paced arena shooter where two players battle each other in a dynamic colosseum.",
  longDescription:
  ...
  instructions: [
    ...
    "Jump between platforms to gain tactical advantage",
    "Eliminate your opponent to win the match!",
  ],
};
