...
interface Props {
  ...
  /** callback para “regresar” al GamePage */
  onExit?: () => void;
}
    ...
    <div style={containerStyle}>
      ...
      {confirmOpen && (
        <div
          ...
          onClick={() => setConfirmOpen(false)} // click en backdrop cierra
          style={{
            position: 'fixed',
            inset: 0,
            zIndex: 30,
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 13, opacity: .85 }}>
              Puedes volver más tarde desde la página del juego.
            </div>
